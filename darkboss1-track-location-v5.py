...
\__|      \__|  \__|\__|  \__|\________|       \______/ \__|     \__| \______/ 
           ...
           {Wh}|----------------------------------------|
           {Wh}| {Gr}darkboss1 - FAKE-SMS                {Wh}|
           {Wh}| {Gr}@CODE BY darkboss1                   {Wh}|
           {Wh}|----------------------------------------|           
...
\__|      \__|  \__| \______/ \__|  \__| \_______|         \__|\__|      \_______| \_______|\__|  \__| \_______|\__|      
           ...
           {Wh}|----------------------------------------|
           {Wh}| {Gr}darkboss1 - PhoneTracker            {Wh}|
           {Wh}| {Gr}@CODE BY darkboss1                  {Wh}|
           {Wh}|----------------------------------------|                                                                                                                 
...
def infor():
    bannerInfo = f"""    {Mage}       
           ...
           {Wh}|----------------------------------------|
           {Wh}| {Gr}darkboss1 - Username-Tracker           {Wh}|
           {Wh}| {Gr}@CODE BY darkboss1                      {Wh}|
           {Wh}|----------------------------------------|                   
...
def main():
    ...
    try:
        opt = int(input(f"""\n{Re}┌─[{Cy}darkboss1{Blu}~{Wh}@HOME{Re}]
└──╼{Wh}$ """).lower())
